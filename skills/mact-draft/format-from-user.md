# MACT Writ Petition — Format reference

🟡 **Place case-type-specific format text in this file.**

The user should paste their canonical MACT-WP master template into this file. The Drafter agent reads it as the authoritative source for statutory openings, prayer phrasing, counsel block layout, and other format-level conventions.
...
3. The statutory opening clause (Article 226/227 + MV Act invocation)
4. The party-block format (Petitioner ↔ Respondent — usually State + Insurance Co. + Owner + Driver + the original Claimant if you are insurer-side)
